...
namespace OpenTK_winforms_z02
{
    public partial class Form1 : Form
    {
        ...
        private void DeseneazaCon(float raza, float inaltime, int numarSegmente, int texturaId)
        {
            ...
            for (int i = 0; i <= numarSegmente; i++)
            {
                ...
                GL.TexCoord2(0.5, 0.5);
                GL.Vertex3(x2, y2, z2);
                GL.TexCoord2(0.5 * (1 + Math.Cos((i + 1) * segmentAngle)), 0.5 * (1 + Math.Sin((i + 1) * segmentAngle)));
                GL.Vertex3(x3, y3, z3);
            }
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e)
        {
            ...
            DeseneazaSfera(30, 36, textures[1]);
            ...
            DeseneazaCon(razaCon, inaltimeCon, numarSegmenteCon, textures[0]);
